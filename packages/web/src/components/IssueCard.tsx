...
import { getRuleFriendlyName, getRuleCategory } from '../lib/standards';
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            <span className="text-[10px] text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">
              {getRuleCategory(issue.rule)}
            </span>
            <span className="text-[11px] text-slate-400">{getRuleFriendlyName(issue.rule)}</span>
          </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          {issue.autoFixable && (
            <button
              ...
              aria-label={`Fix: ${getRuleFriendlyName(issue.rule)}`}
            >
          ...
          <div className="px-4 pb-4 pt-0 space-y-2.5 border-t border-slate-100">
            <div className="pt-3">
              ...
              <div className="flex items-baseline gap-2 text-xs">
                <span className="text-slate-400 font-medium">We spotted:</span>
                <button
            ...
            {issue.suggestion && (
              <div className="flex items-baseline gap-2 text-xs">
                <span className="text-slate-400 font-medium">Suggestion:</span>
